...
//! 2. The token is intended to be used with you application (`aud` field)
//! 3. The token has not expired (`exp` field)
//! 4. The tokens issue date (`iat` field)
//! 5. That the tokens valid date is not in the future (`nbf` field)
//!
